...
def faceDetection(test_img):
    gray_img=test_img #cv2.cvtColor(test_img,cv2.COLOR_BGR2GRAY)#convert color image to grayscale
    face_haar_cascade=cv2.CascadeClassifier('E:/Python projects/face_detection_neha/FaceRecognition-master/HaarCascade/haarcascade_frontalface_default.xml')#Load haar classifier
...
def put_text(test_img,text,x,y):
    cv2.putText(test_img,text,(x+20,y-10),cv2.FONT_HERSHEY_DUPLEX,2,(255,0,0),4)
